export default {
  ...
  'assigning.form.labels.points': 'Points',
  ...
  'assigning.form.errors.studentsRequired': 'At least one student is required',
  'assigning.form.errors.exerciseSetRequired': 'Exercise set is required',
  'assigning.form.errors.pointsRequired': 'Points are required',
